...
{
    /// <summary>
    /// Colours worth offering. Chosen to be distinguishable from each other at
    /// tag size, which rules out most of a naive rainbow.
    /// </summary>
    private static readonly (string Name, string Hex, string Second)[] Palette =
    [
    ...
    private StackPanel ColourRow(bool first)
    {
        ...
        foreach (var (name, hex, second) in Palette)
        {
